  ...
  const affiliateView = function () {
    ...
    return (
      <div class="page-content">
        <img class="affiliate_program_blur" style="position: absolute; right: 0;" src={affiliate_blur1}/>
    <img class="affiliate_program_blur" style="position: absolute; left: 0;"src={affiliate_blur4}/>
            ...
            <div class="affiliate_program_conditions">
                <div class="affiliate_program_condition">
                    <div class="affiliate_program_condition_icon">
                        <img src={affiliate_conditions_icon1}/>
                    </div>
                ...
                <div class="affiliate_program_condition">
                    <div class="affiliate_program_condition_icon">
                        <img src={affiliate_conditions_icon2}/>
                    </div>
                ...
                <div class="affiliate_program_condition">
                    <div class="affiliate_program_condition_icon">
                        <img src={affiliate_conditions_icon3}/>
                    </div>
                ...
                <div class="affiliate_program_condition">
                    <div class="affiliate_program_condition_icon">
                        <img src={affiliate_conditions_icon4}/>
                    </div>
            ...
            <div class="affiliate_banners_size">
                <div>
                    ...
                    <div class="affiliate_banners_size_list">
                        <div data-action="changeAffiliateBanner" class="affiliate_banners_size_item affiliate_banners_size_item_active">
                            <div class="affiliate_banners_size_item_inner">
                                200x100
                            </div>
                        </div>
                        <div data-action="changeAffiliateBanner" class="affiliate_banners_size_item">
                            <div class="affiliate_banners_size_item_inner">
                                200x200
                            </div>
                        </div>
                    ...
                    <div class="affiliate_banners_size_select">
                        <select class="justselect" id="changeAffiliateBannerSelect">
                            <option selected="selected" value="200x100">200x100</option>
            ...
            <div class="affiliate_banner">
                <div style="display: none;">
                    ...
                    <div class="affiliate_banner_link">
                        ...
                        <div data-action="affiliateBannerCopy" class="affiliate_banner_copy">
                            <img src={copy}/> <span>{lang.p.copy}</span>
                ...
                <div style="display: none;">
                    ...
                    <div class="affiliate_banner_code">
                        <div class="affiliate_banner_code_block">
                            &lt;img src="https://crypto-emergency.com/assets/image/affiliate_banners/417x417.jpg"&gt;
                        </div>
                        <div data-action="affiliateBannerCopy" class="affiliate_banner_copy">
                            <img src={copy}/> <span>{lang.p.copy}</span>
                            <div class="success_copy">{lang.text.coppied}</div>
