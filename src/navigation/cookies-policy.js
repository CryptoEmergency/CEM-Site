import {
  ...
  const cookiesPolicyView = function () {
...
<div class="full_news_container">
  <div class="full_news_block">
    <div class="full_news_content">
      ...
      <h1 class="full_news_name">Политика Cookies</h1>
      <p class="full_news_date">Редакция от 2021-12-16</p>
      <h2 class="full_news_title mrb10">ЧТО ТАКОЕ ФАЙЛЫ COOKIE?</h2>
      <p class="full_news_text mrb40">Файлы cookie — это текстовые файлы
      ...
      <h3 class="full_news_subtitle mrb10">Как я могу контролировать настройки,
        позволяющие использование cookie?</h3>
      <p class="full_news_text mrb40">Если вы не хотите получать файлы cookie,
      ...
      <h3 class="full_news_subtitle mrb10">Как мы используем файлы cookie ?</h3>
      <p class="full_news_text">Мы используем Google Analytics, сервис для
        ...
        пользователя, отправив письмо по адресу
        <a
