...
const BlockUsers = async function ({ limit = 21 }) {
                ...
                <div class="c-friends__block">
                    <div class="c-friends__search">
                        ...
                        <div
                            ...
                            <a
                                class="c-button c-button--primary c-button--icon"
                                href=""
                                title={Variable.lang.a.resetFilter}
                                onclick={async function (e) {
                                    e.preventDefault();
                                    console.log('=48c407= Static =', Static)
                                    switch (Static.type) {
                                        case "creator":
                                    ...
                                    Static.apiFilter = makeFilter(Static)
                                    console.log('=e0de48= Static.apiFilter =', Static.apiFilter)
                                    await fn.restApi.getUsers({ cache: true, name: Static.nameRecords, filter: Static.apiFilter, sort: { "statistic.rating": -1 } })
                                }}
                            >
                                <img class="c-button__image" src={svg.reset_filter} width="30" height="30" />
                                {/* <span class="c-button__wrapper">Сброс</span> */}
                            </a>
                        </div>
                    </div>
