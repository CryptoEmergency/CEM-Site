import {
  ...
  const AudioPlayer = function (item) {
      let audioObj = item.item;
       return (
        ...
        oncanplay={(e) => playerCanplay(e)} ontimeupdate={(e) => playerTimeupdate(e)}  src={`/assets/upload/posts/${audioObj.name}`} >
        </audio>
        <div class="controls">
