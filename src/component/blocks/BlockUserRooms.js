...
const BlockUserRooms = async function ({ Static }) {
  ...
  return (
    ...
    <div class="c-rooms c-container">
      {<aside class="c-chats__aside c-chats__aside--newstyle">
        <div class="c-chats__list">
          <div class="c-chats__checkboxes">
            ...
            >
              <img class="c-chats__checkimg" width="50" height="" src={svg["icon/icon_group_created"]} />
            ...
            >
              <img class="c-chats__checkimg" width="50" height="" src={svg["icon/icon_group_fellowship"]} />

            </div>
          </div>
          <ul class="c-chats__togglers c-chats__togglers--horizontal">
      ...
      <div class="c-rooms__langs c-chats__list c-chats__list--system" style="display: none">
