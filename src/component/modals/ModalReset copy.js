...
const ModalReset = function ({ changeCode, ID, abbr, codeTitle, wayReset, changeWayReset, changeStepReset }) {
        ...
        <div class="c-modal c-modal--open" id="ModalReset">
            <section class="c-modal__dialog">
                <header class="c-modal__header">
                    <h2 class="c-modal__title">{`${showStepReset == "1" ? Variable.lang.h.modal_reset : Variable.lang.h.modal_resetСonfirm}`}</h2>
                    <button
                        type="button"
                    ...
                    <div class="reset_password">
                        <div class={`reset_password_step2 ${showStepReset == "1" && "dn"}`}>
                            ...
                            <div type="button" class="reset-btn" id="reset_next_step-2">
                                <a class="btn-reset"><span>{Variable.lang.button.next}</span></a>
                            </div>
                        </div>
                    </div>
                </div >
